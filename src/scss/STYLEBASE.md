...
These rules govern StyleBase styles and class usage across frameworks. Application architecture and business logic are governed by the adopting project's instructions.

Unless stated otherwise, paths in this document are relative to the directory containing STYLEBASE.md.
...
4. Update breakpoint lists in `STYLEBASE.md` and the project `README.md`
